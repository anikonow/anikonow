...
%positble tsp adjust (part of uav solver)
...
targetsoft = .95; %shallow water risk
...
refoutline=readtable("TestData\Test_22\Test22_outline_high.txt");
...
p1=normcdf(shallowcutsoft(1,1),z,zcov);
p2=normcdf(shallowcutsoft(1,2),z,zcov); % tranducer depth
r=p2-p1;
...
levels = [1-targetsoft,1-targetsoft]; 
...
% % filename = 'Test26B_waypoints.waypoints';
% % 
...
% % 
% % 
% % save('Test26B_data.mat',"costj","buffer","rotationangle","riskobby","ObsticalVertices","polyroi","WGS1984")
